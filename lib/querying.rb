...
def select_series_title_with_most_human_characters
	...
	ORDER BY characters.species = 'human' LIMIT 1;"
end

def select_character_names_and_number_of_books_they_are_in
	"SELECT characters.name, SUM(character_id = character_books.character_id)
	FROM characters
	...
	ORDER BY SUM(character_id = character_books.character_id) DESC, characters.name;"
end
